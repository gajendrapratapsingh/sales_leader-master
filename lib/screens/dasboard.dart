...
import 'package:glen_lms/screens/dashboard_screens/my_activities.dart';
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: <BottomNavigationBarItem>[
            ...
            BottomNavigationBarItem(
              icon: _buildIcon("assets/images/leads.png", "My Activity", 1),
              title: SizedBox.shrink(),
            ),
            /*BottomNavigationBarItem(
            ...
            BottomNavigationBarItem(
              icon: _buildIcon("assets/images/user.png", "Profile", 2),
              title: SizedBox.shrink(),
            ),
          ],
