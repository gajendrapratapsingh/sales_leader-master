...
class _ResetPinState extends State<TourDAList>
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          ...
          return Column(children: <Widget>[
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: <Widget>[
                                  Row(children: <Widget>[
                                    Expanded(
                                      child: snapshot.data['user_da_price'] !=
                                              null
                                          ? Text(
                                              "User DA Price: " +
                                                  "₹ " +
                                                  snapshot.data['user_da_price']
                                                      .toString(),
            ...
            snapshot.data['tour_list'].length != 0
  ...
  Widget build(BuildContext context) {
    ...
    return Container(color: Colors.grey[200], child: mainWidget(deviceSize));
  }
}
