                        ...
                        if(member_id=="") {
                          Navigator.pushNamed(
                            ...
                            arguments: <String, String>{
                              'lead_id': snapshot.data['visit_details'][0]['linkid'].toString(),
                              'type':''
                ...
                children: <Widget>[
                  ...
                  /*Container(
                    ...
                    child: Row(
                       mainAxisAlignment: MainAxisAlignment.spaceBetween,
                       children: [
                          Text("Order", style: TextStyle(color: Colors.black, fontSize: 14.0)),
                          IconButton(
                              onPressed: (){},
                              icon: Icon(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text("No Order", style: TextStyle(color: Colors.black, fontSize: 14.0)),
                              IconButton(
                                onPressed: (){},
                                icon: Icon(
                                  Icons.arrow_forward_ios,
                  ...
                  Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Tracker", style: TextStyle(color: Colors.black, fontSize: 14.0)),
                          IconButton(
                            onPressed: (){},
                            icon: Icon(
                              Icons.arrow_forward_ios,
