  ...
  void initState() {
    ...
    if (widget.argument != null) {
      ...
      if (selectedDateStart != null) {
        ...
        calenderDateStart =
            format.parse(selectedDateStart.replaceAll('-', '.'));
...
//    var dir = await path_provider.getTemporaryDirectory();
      ...
      if (mounted) {
        setState(() {
          for (int i = 0; i < result.length; i++) {
            ...
            if (tour_tittle != "") formData = result[i];
            print(cities1);
          }
        });
      }
    ...
    return InkWell(
      onTap: () async {
        if (_formKey.currentState.validate()) {
          ...
          var uri = Uri.parse(URL + 'save_expense_reimbursments');
  ...
  Future<DateTime> getDate() {
    ...
    return showDatePicker(
      context: context,
      initialDate:
          calenderDateStart != null ? calenderDateStart : DateTime.now(),
                                          ...
                                          setState(() {
                                            for (int i = 0;
                                              ...
                                              if (value == cities[i]) {
                                                ...
                                                calenderDateStart = format
                                                    .parse(selectedDateStart
                                                        .replaceAll('-', '.'));
                                                calenderDateEnd = format.parse(
