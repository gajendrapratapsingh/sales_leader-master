...
class _ResetPinState extends State<NotificationList>
  ...
  Future _leadData() async {
    var response = await http.post(
      Uri.parse(URL + "notificationlist"),
      body: {
  ...
  Widget _emptyOrders() {
    return Center(
      child: Container(child: Text('NO NOTIFICATIONS FOUND!')),
    );
  }
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Row(children: <Widget>[
                                            ...
                                            snapshot.data['notification_list'][index]['send_nofication_time'] !=
                                                    null
                                                ? Expanded(
                                                    child: Text(snapshot.data['notification_list'][index]['send_nofication_time'],
