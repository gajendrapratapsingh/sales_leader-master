...
class _ResetPinState extends State<MyOrders>
                                    ...
                                    setState(() {
                                      ...
                                      if (_dropdownValue == "Select Status") {
                                        ...
                                        if (fromDateController.text == "" &&
                                          ...
                                          _leads = _leadData(name,
                                              formattedDate2, formattedDate1);
                                        } else {
                                          _leads = _leadData(
                                              name,
  ...
  Widget _emptyOrders() {
    return Center(
      child: Container(child: Text('NO ORDER FOUND!')),
    );
  }
                            ...
                            onTap: () {
                              Navigator.pushNamed(
                                ...
                                arguments: <String, String>{
                                  'order_id': snapshot.data['orderlist'][index]
                                          ['id']
                                      .toString(),
                                  'type': '',
                                  'member_id': member_id,
