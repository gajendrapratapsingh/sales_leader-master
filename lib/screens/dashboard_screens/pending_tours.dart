...
class _ResetPinState extends State<PendingTours>
  ...
  Widget _emptyOrders() {
    return Center(
      child: Container(child: Text('NO TOURS FOUND!')),
    );
  }
                ...
                InkWell(
                  ...
                  onTap: () async {
                    if (cmtController.text != "") {
                      var response = await http.post(
                        Uri.parse(URL + "tourstatuschanged"),
                        body: {
                          "auth_key": "VrdoCRJjhZMVcl3PIsNdM",
                            ...
                            onTap: () {
                              Navigator.pushNamed(
                                ...
                                arguments: <String, String>{
                                  'tour_id': snapshot.data['tour_plan_list']
                                          [index]['id']
                                      .toString(),
                              ...
                              child: Row(
                                  ...
                                  children: <Widget>[
                                    CircleAvatar(
                                      ...
                                      child: Center(
                                        child: Text(
                                          snapshot.data['tour_plan_list'][index]
                                                  ['tour_tittle'][0]
                                              .toUpperCase(),
                                          style: TextStyle(
                                              fontSize: 30.0,
