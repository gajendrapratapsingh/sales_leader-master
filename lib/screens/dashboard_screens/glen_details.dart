...
class _ResetPinState extends State<GlenDetails> {
  ...
  Future _leadData() async {
    var response = await http.post(
      Uri.parse(URL + "glen_promotion_details"),
      body: {
          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    ...
                    CircleAvatar(
                      ...
                      radius: 28,
                      child: Center(
                        child: snapshot.data['glen_promotionlist_details'][0]
                                    ['dealer_name'] !=
                                ""
                            ? Text(
                                snapshot.data['glen_promotionlist_details'][0]
                                        ['dealer_name'][0]
                                    .toUpperCase(),
                                style: TextStyle(
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Text(
                                    snapshot.data['glen_promotionlist_details']
                                        [0]['location'],
                                    overflow: TextOverflow.ellipsis,
                                    maxLines: 3,
                                    style: TextStyle(color: Colors.black54),
                ...
                SizedBox(height: 10.0),
                snapshot.data[',glen_promotion_document_list'].length != 0
                    ? GridView.count(
                        crossAxisCount: 3,
                        shrinkWrap: true,
                        primary: false,
                        ...
                        children: List.generate(
                            snapshot.data[',glen_promotion_document_list']
                                .length, (index) {
                          return InkWell(
                            onTap: () {
