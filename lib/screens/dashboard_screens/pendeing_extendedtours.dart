...
class _ResetPinState extends State<PendingExtendedTours>
  ...
  Future _leadData() async {
    var response = await http.post(
      Uri.parse(URL + "extendtourplanlists"),
      body: {
                            ...
                            onTap: () {
                              Navigator.pushNamed(
                                ...
                                arguments: <String, String>{
                                  'tour_id': snapshot
                                      .data['extend_tour_plan_list'][index]
                                          ['id']
                                      .toString(),
                              ...
                              child: Row(
                                  ...
                                  children: <Widget>[
                                    CircleAvatar(
                                      ...
                                      child: Center(
                                        child: Text(
                                          snapshot.data['extend_tour_plan_list']
                                                  [index]['tour_tittle'][0]
                                              .toUpperCase(),
                                          style: TextStyle(
                                              fontSize: 30.0,
