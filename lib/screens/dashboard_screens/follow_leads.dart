...
class _ResetPinState extends State<MyFollowLeads>
  ...
  Widget _emptyOrders() {
    return Center(
      child: Container(child: Text('NO LEADS FOUND!')),
    );
  }
                        ...
                        child: ClipRRect(
                          ...
                          child: InkWell(
                              ...
                              if (widget.recordName == "") {
                                Navigator.pushNamed(
                                  ...
                                  arguments: <String, String>{
                                    'lead_id': snapshot.data['lead_list'][index]
                                            ['id']
                                        .toString(),
                                    'type': ''
                                  },
                            ...
                            child: Container(
                              ...
                              decoration: snapshot.data['lead_list'][index]
                                          ['colorcode'] !=
                                      "#fff"
