            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    ...
                    CircleAvatar(
                      ...
                      child: Center(
                        child: Text(
                          snapshot.data['expense_details'][0]['category'][0]
                              .toUpperCase(),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text(
                            "Type: " +
                                snapshot.data['expense_details'][0]['type'],
                            style: TextStyle(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Text(
                                    "Ex. Date : " +
                                        snapshot.data['expense_details'][0]
                                            ['ex_date'],
                ...
                Container(
                  ...
                  child: Text(
                    "Ex. Date: " +
                        snapshot.data['expense_details'][0]['ex_date'],
                    style: smallText,
                  ),
                ),
                SizedBox(height: 5.0),
                snapshot.data['expense_details'][0]['from_city'] != null
                    ? Container(
                        width: MediaQuery.of(context).size.height * 0.80,
                        margin: const EdgeInsets.only(left: 16, right: 16),
                        padding: const EdgeInsets.all(14.0),
                ...
                SizedBox(height: 5.0),
                snapshot.data['expense_details'][0]['travel_mode'] != null
                    ? Container(
                        width: MediaQuery.of(context).size.height * 0.80,
                        margin: const EdgeInsets.only(left: 16, right: 16),
                        padding: const EdgeInsets.all(14.0),
                    ...
                    : Container(),
                SizedBox(height: 5.0),
                snapshot.data['expense_details'][0]['hotel_name'] != null
                    ? Container(
                        width: MediaQuery.of(context).size.height * 0.80,
                        margin: const EdgeInsets.only(left: 16, right: 16),
                        padding: const EdgeInsets.all(14.0),
                    ...
                    : Container(),
                SizedBox(height: 5.0),
                snapshot.data['expense_details'][0]['city'] != null
                    ? Container(
                        width: MediaQuery.of(context).size.height * 0.80,
                        margin: const EdgeInsets.only(left: 16, right: 16),
                        padding: const EdgeInsets.all(14.0),
                    ...
                    : Container(),
                SizedBox(height: 5.0),
                snapshot.data['expense_details'][0]['no_of_night'] != null
                    ? Container(
                        width: MediaQuery.of(context).size.height * 0.80,
                        margin: const EdgeInsets.only(left: 16, right: 16),
                        padding: const EdgeInsets.all(14.0),
                    ...
                    : Container(),
                SizedBox(height: 5.0),
                snapshot.data['expense_details'][0]['comments'] != null
                    ? Container(
                        width: MediaQuery.of(context).size.height * 0.80,
                        margin: const EdgeInsets.only(left: 16, right: 16),
                        padding: const EdgeInsets.all(14.0),
                            ...
                            onTap: () {
                              Navigator.push(context,
                                ...
                                return FullScreenImage(
                                  imageUrl: snapshot.data['attachment_url'] +
