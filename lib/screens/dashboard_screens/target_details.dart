...
class _ResetPinState extends State<SalesTargetDetails> {
  ...
  Future _leadData() async {
    var response = await http.post(
      Uri.parse(URL + "sales_target_details"),
      body: {
                  ...
                  child: Card(
                    child: Column(
                      ...
                      children: [
                        ...
                        snapshot.data['targethistory'].length != 0
                            ? Container(
                                margin:
                                ...
                                child: ListView.builder(
                                    ...
                                    primary: false,
                                    itemCount:
                                        snapshot.data['targethistory'].length,
