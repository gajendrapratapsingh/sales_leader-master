...
class _ResetPinState extends State<ProductList>
  ...
  Future _getCityCategories(type) async {
    ...
    var response = await http.post(
      Uri.parse(URL + "getsubcategorylist"),
      body: {
        "auth_key": "VrdoCRJjhZMVcl3PIsNdM",
    ...
    print(jsonEncode(
        {"auth_key": "VrdoCRJjhZMVcl3PIsNdM", "category_id": type.toString()}));
    if (response.statusCode == 200) {
      setState(() {
        _loading = false;
      });
            ...
            onPressed: () {
              ...
              showSearch(
                  ...
                  delegate: ProductSearch(
                      _type, _type1, selectedRegion, selectedCity),
                  query: '');
            },
          ),
        ],
...
class ProductSearch extends SearchDelegate<String> {
  ...
  var _selectedS;
  ProductSearch(
      this._categoryId, this._subCategoryId, this._selectedC, this._selectedS);
  ...
  Future _productList(query) async {
    ...
    var response = await http.post(
      Uri.parse(URL + "searchproductlist"),
      body: {"auth_key": "VrdoCRJjhZMVcl3PIsNdM", "search_key": query},
      headers: {
        "Accept": "application/json",
      },
    );
    print({"auth_key": "VrdoCRJjhZMVcl3PIsNdM", "search_key": query});
    if (response.statusCode == 200) {
      var data = json.decode(response.body);
      print(data);
      //var result = data['Response'];
                ...
                onTap: () {
                  ...
                  Navigator.pushNamed(
                    ...
                    arguments: <String, String>{
                      'category_id': snapshot.data['product_list'][index]
                              ['category_id']
                          .toString(),
                      'sub_category_id': snapshot.data['product_list'][index]
                              ['sub_category_id']
                          .toString(),
