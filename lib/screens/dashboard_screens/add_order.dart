        ...
        for (int i = 0; i < items.length; i++) {
          if (subject == "users") {
            if (role == "Sales Promoter") {
              _total = _total +
                  (int.parse(items[i].mop) * int.parse(items[i].quantity));
            } else {
              _total = _total +
                  (int.parse(items[i].current_price) *
                                                      ...
                                                      subject == "users"
                                                          ? type ==
                                                              ...
                                                              ? Container(
                                                                  ...
                                                                  child: Text(
                                                                    "₹ " +
                                                                        '${(int.parse(items[position].mop) * int.parse(items[position].quantity)).toString()}',
                                                                    overflow:
                                                                        TextOverflow
                                                                            .ellipsis,
                                                                    maxLines: 1,
                                                              ...
                                                              : Container(
                                                                  ...
                                                                  child: Text(
                                                                    "₹ " +
                                                                        '${(int.parse(items[position].current_price) * int.parse(items[position].quantity)).toString()}',
                                                                    overflow:
                                                                        TextOverflow
                                                                            .ellipsis,
                                                                    maxLines: 1,
                                                                    ...
                                                                    for (int i =
                                                                      ...
                                                                      if (subject ==
                                                                        ...
                                                                        if (role ==
                                                                            "Sales Promoter") {
                                                                          _total =
                                                                              _total + (int.parse(items[i].mop) * int.parse(items[i].quantity));
                                                                        } else {
                                                                          _total =
                                                                              _total + (int.parse(items[i].current_price) * int.parse(items[i].quantity));
                                                                        }
                                                                      } else {
                                                                        _total =
                                                                            _total +
