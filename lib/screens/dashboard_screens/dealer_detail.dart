...
class _ResetPinState extends State<DealerDetails> {
  ...
  Future _leadData() async {
    var response = await http.post(
      Uri.parse(URL + "contactdealerdetails"),
      body: {
              ...
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    ...
                    CircleAvatar(
                      ...
                      child: Center(
                        child:
                            snapshot.data['dealer_details']['dealer_name'] != ""
                                ? Text(
                ...
                Container(
                  ...
                  child: Text("Owner Name : " +
                      snapshot.data['dealer_details']['owner_name']),
                ),
                SizedBox(height: 10.0),
                Container(
                  width: MediaQuery.of(context).size.height * 0.80,
                  ...
                  decoration: BoxDecoration(color: Colors.grey.shade200),
                  child: Text("Zip Code : " +
                      snapshot.data['dealer_details']['pincode']),
                ),
                SizedBox(height: 10.0),
                Container(
                  width: MediaQuery.of(context).size.height * 0.80,
                ...
                SizedBox(height: 10.0),
                snapshot.data['dealer_details']['comments'] != null
                    ? Container(
                        width: MediaQuery.of(context).size.height * 0.80,
                        margin: const EdgeInsets.only(left: 16, right: 16),
                        padding: const EdgeInsets.all(14.0),
                        decoration: BoxDecoration(color: Colors.grey.shade200),
                        child: Text("Comments : " +
                            snapshot.data['dealer_details']['comments']),
                      )
                    : Container(),
                SizedBox(height: 10.0),
                Container(
