  ...
  Future _leadData() async {
    ...
    if (response.statusCode == 200) {
      ...
      for (int i = 0; i < data['orderpproductlist'].length; i++) {
        ...
        _total = _total +
            (int.parse(data['orderpproductlist'][i]['current_price']) *
                ...
                Row(
                  children: <Widget>[
                    ...
                    CircleAvatar(
                      ...
                      radius: 28,
                      child: Center(
                        child: snapshot.data['orderlist'][0]['dealer_name'] !=
                                null
                            ? Text(
                    ...
                    Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          snapshot.data['orderlist'][0]['dealer_name'] != null
                              ? Text(
                                  "Name : " +
                        ...
                        child: Card(
                          child: Column(
                            ...
                            children: [
                              ...
                              ListView.builder(
                                  itemCount:
                                      snapshot.data['orderpproductlist'].length,
                                  shrinkWrap: true,
                                  primary: false,
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            _controllers[i]
                                                                ...
                                                                ? Container(
                                                                    ...
                                                                    child: Text(
                                                                      "₹ " +
                                                                          '${(int.parse(snapshot.data['orderpproductlist'][i]['current_price']) * snapshot.data['orderpproductlist'][i]['quantity']).toString()}',
                                                                      overflow:
                                                                          TextOverflow
                                                                              .ellipsis,
                                                                      maxLines:
                                                                ...
                                                                : Container(
                                                                    ...
                                                                    child: Text(
                                                                      "₹ " +
                                                                          '${(int.parse(snapshot.data['orderpproductlist'][i]['current_price']) * int.parse(quantityList[i])).toString()}',
                                                                      overflow:
                                                                          TextOverflow
                                                                              .ellipsis,
                                                                      maxLines:
                                                                      ...
                                                                      onChanged:
                                                                        ...
                                                                        setState(
                                                                          ...
                                                                          for (int i = 0;
                                                                              ...
                                                                              i++) {
                                                                            _total =
                                                                                _total + (int.parse(snapshot.data['orderpproductlist'][i]['current_price']) * int.tryParse(quantityList[i]));
                                                                            print(_total.toString());
                                                                          }
                                                                        });
                                ...
                                Slidable(
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(boxShadow: [
                                      BoxShadow(
                                        color:
                                            Color(0xFFfae3e2).withOpacity(0.3),
                                        spreadRadius: 1,
                                        blurRadius: 1,
                                        offset: Offset(0, 1),
                                      ),
                                                    ...
                                                    Row(
                                                      ...
                                                      children: <Widget>[
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Text(
                                                            "₹ " +
                                                                '${(int.parse(i['current_price']) * i['quantity']).toString()}',
                                                            overflow:
                                                                TextOverflow
                                                                    .ellipsis,
                                                            maxLines: 1,
    ...
    return InkWell(
      onTap: () async {
        ...
        for (int i = 0; i < data.length; i++) {
          ...
          xmlList.add(xmljson);
          _total = _total +
              int.parse(data[i]['current_price']) * int.parse(quantityList[i]);
        }
